...
public final class Border {
    ...
    public static BufferedImage drawBorder(BufferedImage img, String title) throws IOException, FontFormatException {
        ...
        try (InputStream fontStream = Border.class.getResourceAsStream("/fonts/GeographicaHand_Regular.otf")) {
            if (fontStream == null) {
                throw new IOException("Missing map border font resource.");
            }
            Font customFont = Font.createFont(Font.TRUETYPE_FONT, fontStream).deriveFont(340f);
